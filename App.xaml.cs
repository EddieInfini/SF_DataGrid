...
using SF_DataGrid.Contracts.Views;
using SF_DataGrid.Models;
using SF_DataGrid.Services;
using SF_DataGrid.ViewModels;
using SF_DataGrid.Views;

namespace SF_DataGrid
{
    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            Syncfusion.Licensing.SyncfusionLicenseProvider.RegisterLicense("Ngo9BigBOggjHTQxAR8/V1NBaF5cXmZCekx0Rnxbf1x0ZFRGal1VTnZXUj0eQnxTdEFjWn1acnZXQGBaUEFzXA==");
        }
